  ...
  return (
    <div className="flex flex-col lg:flex-row flex-wrap text-gray-600">
      <div className="lg:w-8/12 py-10">
        <h1 className="border-b text-gray-600 text-xl font-medium py-3">
          Review your order
        </h1>
        <CartList final />
      </div>
      ...
      <div className="lg:w-8/12 bg-lightBlue p-5 grid lg:grid-cols-2 gap-5 lg:gap-0 text-gray-600">
        <div className="flex flex-col gap-2 text-sm">
          <h1 className="text-lg font-medium">Shipping to:</h1>
          <span className="text-gray-400">
            Client: <span className="text-gray-500">Susan Gardner</span>
          </span>
          <span className="text-gray-400">
            Address:{" "}
          ...
          <span className="text-gray-400">
            Phone: <span className="text-gray-500">+1 (808) 764 554 330</span>
          </span>
        </div>
        <div className="flex flex-col gap-2 text-sm">
          ...
          <span className="text-gray-400">
            Credit Card:{" "}
            <span className="text-gray-500">**** **** **** 5300</span>
          </span>
        </div>
      </div>
